  ...
  return (
    <Section id="intro">
      <TextContainer>
        ...
        <Description>
          I’m a frontend developer with 3+ years of experience building customer-facing apps and admin platforms for some of Korea’s largest coffee franchises, including Mega Coffee, Mammoth Coffee, The Liter, and Holly's Coffee. I focus on creating seamless user experiences and scalable solutions that help businesses run more efficiently.
        </Description>
